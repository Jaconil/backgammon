...
/* Proc�dure de saisie du nom d'un joueur
 * @param char** name
 *      Nom du joueur
...
/* Proc�dure de gestion des evenements du menu
...
void DisplayText(SDL_Surface* window, TTF_Font* font, E_GameMode gameMode, E_MenuSelected selected)
{
    ...
    else
    {
        ...
        txtOption1 = TTF_RenderText_Blended(font, "Match instantan�", black);
...
/* Proc�dure de gestion de l'affichage des overlays
 * @param SDL_Surface* window
 *     Surface de la fenetre
 * @param TTF_Font* font
 *     Police des textes
...
/* Proc�dure d'initialisation des noms des joueurs
 * @param S_GameConfig gameConfig
 *     Structure de configuration du jeu
 * @param E_GameMode gameMode
 *     Mode de jeu du programme en cours
...
/* Proc�dure de gestion de l'affichage du menu
 * @param SDL_Surface* window
 *     Surface de la fenetre
 * @param E_GameMode gameMode
 *     Mode de jeu du programme en cours
